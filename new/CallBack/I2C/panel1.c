...
/*------------------------------------*/
static uint8_t  Panel1_Bus_Data_Rx(uint8_t port, I2C_Packet_Header_Type *hdr, uint8_t *pkt);
static uint8_t  Panel1_Bus_Data_Rx(uint8_t port, I2C_Packet_Header_Type *hdr, uint8_t *pkt)
{
	int self,ll;
	self=45;
...
void Panel1_Bus_Data_Tx(void *in);
void Panel1_Bus_Data_Tx(void *in)
{
	void *pkt;
	int ll,ee;
...
void Panel1_Bus_Init_Rx_CallBack(void);
void Panel1_Bus_Init_Rx_CallBack()
{
	Panel_Bus_1_Master.RxData_Callback = Panel1_Bus_Data_Rx;
}
/*================================================================*/
/* end of Panel1.c */
