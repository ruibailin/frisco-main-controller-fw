...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PF5     ------> ADC3_IN15
    */
    GPIO_InitStruct.Pin = SYS_TEMP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SYS_TEMP_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(INPUT_VOLTAGE_GPIO_Port, INPUT_VOLTAGE_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF5     ------> ADC3_IN15
    */
    HAL_GPIO_DeInit(SYS_TEMP_GPIO_Port, SYS_TEMP_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = I2C1_SLOT_SCL_Pin|I2C1_SLOT_SDA_Pin;
  ...
  */
    ...
    PF1     ------> I2C2_SCL
    */
    GPIO_InitStruct.Pin = I2C2_STM_SDA_Pin|I2C2_STM_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PH8     ------> I2C3_SDA
    */
    GPIO_InitStruct.Pin = I2C3_LED_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(I2C3_LED_SCL_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = I2C3_LED_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(I2C3_LED_SDA_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PF15     ------> I2C4_SDA
    */
    GPIO_InitStruct.Pin = I2C4_LED_SCL_Pin|I2C4_LED_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C1_SLOT_SCL_GPIO_Port, I2C1_SLOT_SCL_Pin);

    HAL_GPIO_DeInit(I2C1_SLOT_SDA_GPIO_Port, I2C1_SLOT_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(I2C2_STM_SDA_GPIO_Port, I2C2_STM_SDA_Pin);

    HAL_GPIO_DeInit(I2C2_STM_SCL_GPIO_Port, I2C2_STM_SCL_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PH8     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(I2C3_LED_SCL_GPIO_Port, I2C3_LED_SCL_Pin);

    HAL_GPIO_DeInit(I2C3_LED_SDA_GPIO_Port, I2C3_LED_SDA_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PF15     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(I2C4_LED_SCL_GPIO_Port, I2C4_LED_SCL_Pin);

    HAL_GPIO_DeInit(I2C4_LED_SDA_GPIO_Port, I2C4_LED_SDA_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PI3     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = SPI2_LED2_SCLK_Pin|SPI2_LED2_MISO_Pin|SPI2_LED2_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END SPI3_MspInit 0 */
    ...
    PB4     ------> SPI3_MISO
    */
    GPIO_InitStruct.Pin = SPI3_LED1_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_SPI3;
    HAL_GPIO_Init(SPI3_LED1_MOSI_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SPI3_LED1_SCLK_Pin|SPI3_LED1_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PI3     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOI, SPI2_LED2_SCLK_Pin|SPI2_LED2_MISO_Pin|SPI2_LED2_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB4     ------> SPI3_MISO
    */
    HAL_GPIO_DeInit(GPIOB, SPI3_LED1_MOSI_Pin|SPI3_LED1_SCLK_Pin|SPI3_LED1_MISO_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB9     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = RADAR_SPEED_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_UART5;
    HAL_GPIO_Init(RADAR_SPEED_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = RADAR_SPEED_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_UART5;
    HAL_GPIO_Init(RADAR_SPEED_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PF7     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = UART7_STM_EXT_RX_Pin|UART7_STM_EXT_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PE1     ------> UART8_TX
    */
    GPIO_InitStruct.Pin = RADAR_STATS_RX_Pin|RADAR_STATS_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PC11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = USART3_STM_TX_Pin|USART3_STM_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_USART_MspInit(USART_HandleTypeDef* husart)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = USART1_CK_Pin|USART1_TX_Pin|USART1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB9     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, RADAR_SPEED_RX_Pin|RADAR_SPEED_TX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PF7     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOF, UART7_STM_EXT_RX_Pin|UART7_STM_EXT_TX_Pin);
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, RADAR_STATS_RX_Pin|RADAR_STATS_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, USART3_STM_TX_Pin|USART3_STM_RX_Pin);
...
void HAL_USART_MspDeInit(USART_HandleTypeDef* husart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART1_CK_Pin|USART1_TX_Pin|USART1_RX_Pin);
